        ...
        <div className="ml-5 mr-4 flex items-center font-poppins text-white sm:ml-6 sm:mr-5 md:mx-11 md:max-w-[280px] lg:mx-14">
          <div className="py-6 sm:py-8">
            <div className="mb-4 text-[15px] font-medium md:mb-10 md:text-[25px] lg:text-[35px]">
              <span>
                Abdijabar helped us deliver a high performance application 
              </span>
            </div>
            <div className="flex gap-x-2 md:gap-x-4">
              <div className="flex-none">
                <img
                  src={ClientRounded}
                  alt="Client Rounded"
                  className="h-[24px] w-[24px] rounded-[30px] object-contain md:h-[50px] md:w-[50px] lg:h-[70px] lg:w-[70px]"
                />
              </div>
              <div className="flex-none self-end">
                <div className="text-[8px] font-bold md:text-md lg:text-[16px]">
                  <span>Abdijabaar Mohamed</span>
                </div>
                <div className="text-[7px] md:text-xs lg:text-sm">
                  <span>Tiigsi student</span>
                </div>
              </div>
            </div>
          </div>
